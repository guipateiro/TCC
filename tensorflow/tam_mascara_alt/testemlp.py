...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(15, activation='relu', name= "meio"),
...
nome_arq_precisao = "data/precisao_mascara_" + parametro + ".txt"
...
nome_arq_pesos = "data/pesos_mascara_" + parametro + ".txt"
